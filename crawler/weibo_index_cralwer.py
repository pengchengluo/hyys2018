...
time.sleep(3)
print(browser.execute_script('return echart_resources;'))
browser.execute_script('alert(JSON.stringify(echart_resources.chart.pc_mobile.origin.component.grid.myChart.component.xAxis.series))')
